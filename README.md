...
Static webpage that draws 3D graphs of natural integers relationships. Based on vanilla javascript, webworkers and [3D force graph] (https://github.com/vasturiano/3d-force-graph).
...
You can try it on the [github page] (https://nuel-mathieu.github.io/Natural-integers-relationship-graphs/).
Notable results are :
